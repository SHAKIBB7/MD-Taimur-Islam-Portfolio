...
export const cvContent: PortfolioContent = {
  ...
  skills: [
    { name: "HTML & CSS", category: "LANGUAGES_AND_FRAMEWORKS", level: 82 },
    { name: "Python", category: "LANGUAGES_AND_FRAMEWORKS", level: 74 },
    { name: "WordPress", category: "TOOLS_AND_PLATFORMS", level: 78 },
    { name: "Microsoft Office Suite", category: "TOOLS_AND_PLATFORMS", level: 86 },
    { name: "System & Device Management", category: "TOOLS_AND_PLATFORMS", level: 76 },
    { name: "Cybersecurity Fundamentals", category: "PROFESSIONAL", level: 62 },
    { name: "Problem Analysis & Solving", category: "PROFESSIONAL", level: 84 },
    { name: "Teamwork & Collaboration", category: "PROFESSIONAL", level: 90 },
    { name: "Critical Thinking", category: "PROFESSIONAL", level: 84 },
    { name: "Time Management & Organization", category: "PROFESSIONAL", level: 85 },
    { name: "Communication", category: "PROFESSIONAL", level: 88 },
  ],
  projects: [
    {
